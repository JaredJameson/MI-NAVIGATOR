...
export interface CompanyProfileKRSData {
  lookup_type: string
  identifier: string
...
interface CompanyProfileKRSProps {
  data: CompanyProfileKRSData
}
      ...
      <div className="border-b bg-blue-50 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-blue-900">Dane z {source}</h3>
          </div>
          <span className="text-xs text-blue-700">Wyszukano po {lookup_type}: {identifier}</span>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <div className="mb-4 border-b pb-3">
          <div className="flex items-start justify-between">
            <div>
              <h4 className="text-lg font-bold text-gray-900">{basic_info.name}</h4>
